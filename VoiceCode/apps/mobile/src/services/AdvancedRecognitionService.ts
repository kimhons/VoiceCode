...
import { WebSocketStreamingService, StreamingOptions } from './WebSocketStreamingService';
import { aimlApiService, ProfessionalMode } from './aiml-api.service';
...
export class AdvancedRecognitionService {
  private streamingService: WebSocketStreamingService;
  ...
  constructor(apiKey: string) {
    this.streamingService = new WebSocketStreamingService(apiKey);
  }
