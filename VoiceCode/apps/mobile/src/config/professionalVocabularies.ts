...
export const PROFESSIONAL_VOCABULARIES: Record<ProfessionalMode, CustomVocabulary> = {
  ...
  [ProfessionalMode.TECHNICAL]: {
    terms: DEVELOPER_TERMS, // Technical mode uses developer vocabulary
    professionalMode: ProfessionalMode.TECHNICAL,
    caseSensitive: true,
  },
  ...
  [ProfessionalMode.ACADEMIC]: {
    terms: EDUCATION_TERMS, // Academic mode uses education vocabulary
    professionalMode: ProfessionalMode.ACADEMIC,
    caseSensitive: false,
  },
