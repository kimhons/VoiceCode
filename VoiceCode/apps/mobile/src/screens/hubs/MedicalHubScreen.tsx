...
const MedicalHubScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  const handleNavigate = (screenName: string, title: string) => {
    // Navigate to registered screens
  ...
  const quickActions = [
    {
      ...
      icon: 'mic',
      color: '#FF3B30',
      description: 'Voice to clinical notes',
    },
    {
      name: 'SOAPNotes',
      title: 'SOAP Notes',
  ...
  const features = [
    ...
    },
    {
      ...
      icon: 'cloud-upload',
      color: '#5AC8FA',
      description: 'Sync with your EHR',
    },
    {
      ...
      icon: 'folder',
      color: '#5856D6',
      description: 'Clinical templates',
    },
    {
      name: 'BillingCodes',
      title: 'Billing Codes',
