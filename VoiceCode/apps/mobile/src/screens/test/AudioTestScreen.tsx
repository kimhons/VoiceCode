    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={styles.content}>
        ...
        <Card style={styles.card}>
          ...
          <View style={styles.buttonRow}>
            <Button onPress={() => handleChangeSpeed(0.5)} size="small" variant="outline">0.5x</Button>
            <Button onPress={() => handleChangeSpeed(1.0)} size="small" variant="outline">1.0x</Button>
            <Button onPress={() => handleChangeSpeed(1.5)} size="small" variant="outline">1.5x</Button>
            <Button onPress={() => handleChangeSpeed(2.0)} size="small" variant="outline">2.0x</Button>
          </View>
        </Card>
      </View>
    </ScrollView>
