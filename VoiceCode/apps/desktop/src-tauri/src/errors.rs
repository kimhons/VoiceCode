...
use crate::integrations::ai_text_processor::ProcessingEvent;
...
impl From<String> for TextProcessingError {
    fn from(s: String) -> Self {
        TextProcessingError::InvalidOptions(s)
    }
}
...
pub enum ValidationError {
    ...
    #[error("Text too short: {0} characters (minimum: {1})")]
    TextTooShort(usize, usize),

    #[error("Text too long: {0} characters (maximum: {1})")]
    TextTooLong(usize, usize),
