...
// import { getStreamingService } from './websocket-streaming.service'; // TODO: Implement streaming
...
export class AudioProcessingService extends EventEmitter<AudioProcessingEvents> {
  ...
  // private streamingService = getStreamingService(import.meta.env.VITE_AIML_API_KEY || ''); // TODO: Implement streaming
  private queue: AudioFile[] = [];
  private isProcessing: boolean = false;
  // private maxConcurrent: number = 1; // TODO: Implement concurrent processing
  ...
  private async transcribeAudio(
    audioFile: AudioFile,
    _audioBuffer: AudioBuffer, // TODO: Use for streaming transcription
    options: AudioProcessingOptions
  ): Promise<Transcript> {
    // Convert AudioBuffer to PCM data
    // const pcmData = this.audioBufferToPCM(audioBuffer); // TODO: Use for streaming transcription
  ...
  /**
   * Convert AudioBuffer to PCM data
   * TODO: Implement for streaming transcription
   */
