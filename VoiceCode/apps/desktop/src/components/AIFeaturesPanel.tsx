      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: isSummarizing ? '#6c757d' : '#FF6B35',
              color: 'white',
              border: 'none',
              borderRadius: '5px',
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: isExtractingKeyPoints ? '#6c757d' : '#28a745',
              color: 'white',
              border: 'none',
              borderRadius: '5px',
              cursor:
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: isDetectingActionItems ? '#6c757d' : '#ffc107',
              color: '#000',
              border: 'none',
              borderRadius: '5px',
              cursor:
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: isAnalyzingSentiment ? '#6c757d' : '#17a2b8',
              color: 'white',
              border: 'none',
              borderRadius: '5px',
              cursor:
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: isDetectingTopics ? '#6c757d' : '#6f42c1',
              color: 'white',
              border: 'none',
              borderRadius: '5px',
              cursor:
