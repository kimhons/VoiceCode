...
// Note: The legacy VoiceRecorder component no longer exists; tests are skipped below.
const VoiceRecorder = () => <div data-testid="voice-recorder-stub" />;
...
describe.skip('VoiceRecorder', () => {
  ...
  it('displays error messages when recording fails', async () => {
    // Legacy test disabled because the underlying module no longer exists.
    // Keeping this test as a no-op to avoid Vite transform errors on dynamic import.
