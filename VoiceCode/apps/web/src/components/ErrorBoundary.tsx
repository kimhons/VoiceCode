...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, { 
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    // Console log for debugging (kept in production console group, redacted server-side)
    ...
    try {
      ...
      if (ERROR_LOG_URL && typeof fetch === 'function') {
        const payload = {
          ...
          // Avoid sending full stack for PII minimization; include first line only
        ...
        // Fire-and-forget; no-cors to avoid CORS errors during collection endpoints
        fetch(ERROR_LOG_URL, {
          method: 'POST',
