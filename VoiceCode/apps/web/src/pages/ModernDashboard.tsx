/**
 * Modern Dashboard - VoiceFlow Pro
 * 3-Column Layout: Templates | Recording Center | Live Transcription
 */

import React, { useState, useCallback } from 'react';
import { 
  Mic, Settings, Globe, Sun, Moon, Monitor, 
  FileText, Clock, Download, Share2, Copy,
  Sparkles, MessageSquare, Tag, Volume2, Languages
} from 'lucide-react';
...
export const ModernDashboard: React.FC = () => {
  ...
  const { currentMode, modeConfig, templates, activeTemplate, selectTemplate } = useProfessionalMode();
  const { user } = useAuth();
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  background: colors.surface,
                  color: colors.text,
                  cursor: transcriptionSegments.length === 0 ? 'not-allowed' : 'pointer',
              ...
              >
                <Sparkles size={20} />
                <span style={{ fontSize: '14px', fontWeight: '500' }}>Format</span>
              </button>
              ...
              >
                ...
                <span style={{ fontSize: '14px', fontWeight: '500' }}>Summarize</span>
              </button>
              ...
              >
                <Tag size={20} />
                <span style={{ fontSize: '14px', fontWeight: '500' }}>Extract</span>
              </button>
              ...
              >
                <Languages size={20} />
                <span style={{ fontSize: '14px', fontWeight: '500' }}>Translate</span>
              </button>
            </div>
          </div>
        </section>
