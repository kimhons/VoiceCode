...
exports.VOICEFLOW_AUDIO_WORKLET_CODE = void 0;
exports.createAudioWorkletModuleURL = createAudioWorkletModuleURL;
/**
 ...
 */
exports.VOICEFLOW_AUDIO_WORKLET_CODE = `
/**
...
function createAudioWorkletModuleURL() {
    const blob = new Blob([exports.VOICEFLOW_AUDIO_WORKLET_CODE], { type: 'application/javascript' });
    return URL.createObjectURL(blob);
}
//# sourceMappingURL=AudioWorkletProcessor.js.map