...
exports.AudioCaptureWebviewV2 = void 0;
const vscode = __importStar(require("vscode"));
const AudioWorkletProcessor_1 = require("./AudioWorkletProcessor");
...
class AudioCaptureWebviewV2 {
     ...
     */
    async startCapture(onAudioData, onStop, onError, options) {
        // Store callbacks
        ...
        this.panel = vscode.window.createWebviewPanel('voiceflowAudioCaptureV2', 'VoiceFlow Audio Capture', { viewColumn: vscode.ViewColumn.One, preserveFocus: true }, {
            enableScripts: true,
            retainContextWhenHidden: true,
        });
        // Set up message handler
        const messageHandler = this.panel.webview.onDidReceiveMessage(this.handleWebviewMessage.bind(this), undefined, this.context.subscriptions);
    ...
    getWebviewContent() {
        ...
        const escapedWorkletCode = this.escapeForTemplate(AudioWorkletProcessor_1.VOICEFLOW_AUDIO_WORKLET_CODE);
...
exports.AudioCaptureWebviewV2 = AudioCaptureWebviewV2;
//# sourceMappingURL=AudioCaptureWebviewV2.js.map