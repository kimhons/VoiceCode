 ...
 */
export type TelemetryEventType = 'activation' | 'deactivation' | 'command_executed' | 'voice_recognition_started' | 'voice_recognition_completed' | 'voice_recognition_error' | 'ai_request_started' | 'ai_request_completed' | 'ai_request_error' | 'file_edit_applied' | 'file_edit_reverted' | 'provider_switched' | 'extension_activated' | 'extension_deactivated' | 'feature_used' | 'error_occurred' | 'performance_metric' | 'chat_feedback' | 'chat_request_completed' | 'codebase_indexed' | 'codebase_search' | 'conversation_saved' | 'conversation_retrieved' | 'cost_tracked' | 'budget_alert' | 'approval_requested' | 'approval_granted' | 'approval_denied' | 'approval_history_cleared' | 'trusted_operations_reset' | 'tool_chain_executed' | 'setting_changed_via_voice' | 'index_updated' | 'index_cleared' | 'session_created' | 'session_cleared' | 'token_usage_recorded' | 'daily_budget_reset' | 'usage_history_cleared' | 'codebase_index_file_removed' | 'codebase_index_file_updated' | 'semantic_search' | 'conversation_session_started' | 'conversation_session_ended' | 'conversation_message_added' | 'conversation_memory_search' | 'conversation_memory_cleared' | 'conversation_memory_imported' | 'usage_limit_reached' | 'upgrade_initiated' | 'usage_reset';
/**
 * Telemetry Event
 */
