...
import { TelemetryService, UsageStatistics } from '../services/TelemetryService';
 ...
 */
export class VoiceFlowDashboardProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'voiceflow.dashboard';
   ...
   */
  public addCommand(command: string, success: boolean): void {
...
<body>
  ...
  private getControlsSection(): string {
    return `
    <div class="controls">
  ...
  private getCommandHistorySection(): string {
    return `
