...
export type TelemetryEventType =
  ...
  | 'approval_granted'
  | 'approval_denied'
  | 'approval_history_cleared'
  | 'trusted_operations_reset'
  | 'tool_chain_executed'
  | 'setting_changed_via_voice'
  | 'index_updated'
  | 'index_cleared'
  | 'session_created'
  | 'session_cleared'
  ...
  | 'daily_budget_reset'
  | 'usage_history_cleared'
  | 'codebase_index_file_removed'
  | 'codebase_index_file_updated'
  | 'semantic_search'
