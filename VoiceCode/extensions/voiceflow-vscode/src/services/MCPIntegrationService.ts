...
import { ToolChainExecutor, ToolChain } from './ToolChainExecutor';
...
export class MCPIntegrationService {
  ...
  private humanApproval?: HumanApprovalService;
...
5. Any breaking changes to be aware of`;
   ...
   */
  private async handleEditorNavigation(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleRefactoring(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleDebugging(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleTestRunner(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleSnippets(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleWorkspaceManagement(params: Record<string, any>): Promise<MCPToolResult> {
    ...
    try {
      switch (action) {
        ...
        case 'get_setting':
          if (!settingKey) return { success: false, error: 'Setting key required' };
   ...
   */
  private async handleDocumentation(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleFormatting(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleDiagnostics(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleSelection(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleComments(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleClipboard(params: Record<string, any>): Promise<MCPToolResult> {
    const { action } = params;
   ...
   */
  private async handleWindowManagement(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleExtensions(params: Record<string, any>): Promise<MCPToolResult> {
    ...
    try {
      switch (action) {
        ...
        case 'install':
          if (!extensionId) return { success: false, error: 'Extension ID required' };
   ...
   */
  private async handleProjectGeneration(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   * Handle code folding
   */
  private async handleFolding(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleMultiCursor(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleLanguageServer(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleTasks(params: Record<string, any>): Promise<MCPToolResult> {
   ...
   */
  private async handleDiffMerge(params: Record<string, any>): Promise<MCPToolResult> {
